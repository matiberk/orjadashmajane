						...
						<div class="col-md-12 col-sm-12 col-xs-12">
						  <div class="x_panel">
							...
							<div style="padding-top:30px;" class="x_title col-md-12 col-sm-12 col-xs-12">
								<h1 class="left"><?php echo $majane->data["titulo"] ?> - Inscriptos</h1>
								<div class="right add-table-button-container">
									<a href="verinscriptos.php?majaneid=<?php echo $majane->data['id'] ?>" class="btn btn-success btn-lg">Ver Inscriptos</a>
								</div>
							</div>
							<?php } ?>
						  </div>
